...
gulp.task('site', ['build', 'build-example'], function() {
  ...
  gulp.src('index.html')
    ...
    .pipe(gulp.dest('site'));
  gulp.src(['README.md', 'index.html', 'css/**', 'images/**', 'img/**', 'node_modules/**/*.js', 'node_modules/**/*.css', 'node_modules/**/*.swf', 'node_modules/**/*.woff','node_modules/**/*.woff2', 'node_modules/**/*.ttf', 'node_modules/**/*.map', 'dist/**', 'test-dist/**'], {base: '.'})
    .pipe(gulp.dest('site'));

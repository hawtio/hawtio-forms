...
gulp.task('watch', ['build'], function() {
  plugins.watch(['test/*', 'libs/**/*.js', 'libs/**/*.css', 'index.html', config.dist + '/*'], function() {
    gulp.start('reload');
  });
...
gulp.task('site', ['build'], function() {
  ...
  gulp.src('index.html')
    ...
    .pipe(gulp.dest('site'));
  gulp.src(['README.md', 'index.html', 'test/*', 'css/**', 'images/**', 'img/**', 'libs/**/*.js', 'libs/**/*.css', 'libs/**/*.swf', 'libs/**/*.woff','libs/**/*.woff2', 'libs/**/*.ttf', 'libs/**/*.map', 'dist/**'], {base: '.'})
    .pipe(gulp.dest('site'));
